...
const STEPS = [
  {
    ...
    body: "Scannez le QR code imprimé sur le présentoir.",
    img: PHOTO.etape1,
  ...
  },
  {
    ...
    body: "Entrez le code situé à côté du QR code, puis ajoutez le lien de votre fiche Google.",
    img: PHOTO.etape2,
    alt: "Écran d'activation du présentoir Reviu dans l'espace client",
  },
  {
    n: "3",
    title: "Installez-le sur votre comptoir",
    body: "Votre présentoir est immédiatement opérationnel. Invitez simplement vos clients à partager leur expérience.",
    img: PHOTO.etape3,
