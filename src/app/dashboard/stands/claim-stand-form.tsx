    ...
    <form action={action} className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <input
          ...
          maxLength={6}
          className="h-11 rounded-xl border border-line bg-canvas px-3.5 font-mono text-sm uppercase tracking-widest text-ink outline-none transition-colors placeholder:font-sans placeholder:tracking-normal placeholder:text-muted focus:border-brand sm:w-32"
        />
        <button
          type="submit"
          disabled={pending}
      ...
      <p className="text-xs text-muted">
        Le code et le PIN figurent avec le présentoir reçu.
      </p>
